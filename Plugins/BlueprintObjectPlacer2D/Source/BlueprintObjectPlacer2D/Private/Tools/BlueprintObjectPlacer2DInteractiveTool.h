...
#include "BlueprintObjectPlacer2DInteractiveTool.generated.h"


/**
 * Builder for UBlueprintObjectPlacer2DInteractiveTool
 */
UCLASS()
class BLUEPRINTOBJECTPLACER2D_API UBlueprintObjectPlacer2DInteractiveToolBuilder : public UInteractiveToolBuilder
{
	GENERATED_BODY()
...
/**
 * Property set for the UBlueprintObjectPlacer2DInteractiveTool
 */
UCLASS(Transient)
class BLUEPRINTOBJECTPLACER2D_API UBlueprintObjectPlacer2DInteractiveToolProperties : public UInteractiveToolPropertySet
{
	GENERATED_BODY()

public:
	UBlueprintObjectPlacer2DInteractiveToolProperties();
...
/**
 * UBlueprintObjectPlacer2DInteractiveTool is an example Tool that allows the user to measure the 
 ...
 */
UCLASS()
class BLUEPRINTOBJECTPLACER2D_API UBlueprintObjectPlacer2DInteractiveTool : public UInteractiveTool, public IClickDragBehaviorTarget
{
	GENERATED_BODY()
...
protected:
	...
	UPROPERTY()
	TObjectPtr<UBlueprintObjectPlacer2DInteractiveToolProperties> Properties;
