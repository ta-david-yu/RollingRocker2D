...
#include "BlueprintObjectPlacer2DInteractiveTool.h"
...
#define LOCTEXT_NAMESPACE "UBlueprintObjectPlacer2DInteractiveTool"

/*
 * ToolBuilder
 */

UInteractiveTool* UBlueprintObjectPlacer2DInteractiveToolBuilder::BuildTool(const FToolBuilderState & SceneState) const
{
	UBlueprintObjectPlacer2DInteractiveTool* NewTool = NewObject<UBlueprintObjectPlacer2DInteractiveTool>(SceneState.ToolManager);
...
UBlueprintObjectPlacer2DInteractiveToolProperties::UBlueprintObjectPlacer2DInteractiveToolProperties()
{
...
void UBlueprintObjectPlacer2DInteractiveTool::SetWorld(UWorld* World)
{
	check(World);
...
void UBlueprintObjectPlacer2DInteractiveTool::Setup()
{
	...
	Properties = NewObject<UBlueprintObjectPlacer2DInteractiveToolProperties>(this, "Measurement");
...
void UBlueprintObjectPlacer2DInteractiveTool::OnUpdateModifierState(int ModifierID, bool bIsOn)
{
...
FInputRayHit UBlueprintObjectPlacer2DInteractiveTool::CanBeginClickDragSequence(const FInputDeviceRay& PressPos)
{
...
void UBlueprintObjectPlacer2DInteractiveTool::OnClickPress(const FInputDeviceRay& PressPos)
{
...
void UBlueprintObjectPlacer2DInteractiveTool::OnClickDrag(const FInputDeviceRay& DragPos)
{
	UpdatePosition(DragPos.WorldRay);
}


FInputRayHit UBlueprintObjectPlacer2DInteractiveTool::FindRayHit(const FRay& WorldRay, FVector& HitPos)
{
...
void UBlueprintObjectPlacer2DInteractiveTool::UpdatePosition(const FRay& WorldRay)
{
...
void UBlueprintObjectPlacer2DInteractiveTool::UpdateDistance()
{
	Properties->Distance = FVector::Distance(Properties->StartPoint, Properties->EndPoint);
}


void UBlueprintObjectPlacer2DInteractiveTool::OnPropertyModified(UObject* PropertySet, FProperty* Property)
{
...
void UBlueprintObjectPlacer2DInteractiveTool::Render(IToolsContextRenderAPI* RenderAPI)
{
