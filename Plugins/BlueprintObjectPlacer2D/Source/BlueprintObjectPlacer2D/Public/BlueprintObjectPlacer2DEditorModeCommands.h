 ...
 */
class FBlueprintObjectPlacer2DEditorModeCommands : public TCommands<FBlueprintObjectPlacer2DEditorModeCommands>
{
public:
	FBlueprintObjectPlacer2DEditorModeCommands();
