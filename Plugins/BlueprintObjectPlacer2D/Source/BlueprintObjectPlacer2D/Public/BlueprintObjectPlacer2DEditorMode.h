...
#include "BlueprintObjectPlacer2DEditorMode.generated.h"
 ...
 */
UCLASS()
class UBlueprintObjectPlacer2DEditorMode : public UEdMode
{
	GENERATED_BODY()

public:
	const static FEditorModeID EM_BlueprintObjectPlacer2DEditorModeId;

	static FString SimpleToolName;
	static FString InteractiveToolName;

	UBlueprintObjectPlacer2DEditorMode();
	virtual ~UBlueprintObjectPlacer2DEditorMode();
